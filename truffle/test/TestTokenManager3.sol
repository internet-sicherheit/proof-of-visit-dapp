...
contract TestTokenManager3 {
    ...
    function testGetUserTokenList() public {
        ...
        address testlocationaddress = 0xFDB3D379ab844A402d8D3369077E074318b9Fa01;
        ...
        string memory expectedJson ='[{"locationaddress":"0xfdb3d379ab844a402d8d3369077e074318b9fa01","locationname":"testname","tokenname":"testtoken","tokensymbol":"tt","token":0"}]';




    
        Assert.equal(expectedJson, povtoken.getUserTokenlist(testUserAddress), "failed");
